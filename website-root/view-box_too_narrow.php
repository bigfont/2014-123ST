...
<div id="wrap">
	<div id="container" class="clearfix">
		...
		<div id="content" style="width: 880px;  margin: 0 auto;">
			...
			<a style="float: right;" href="view.php?artist=<?=$prev?>"  onclick="return goPrev();" title="Click to see previous artist<br />or use left keyboard arrow key"><< Prev</a>
				 ...
				 <table width="100%" class="contact_info">
				 	...
				 	<tr><td valign="top" ><strong>Hours:</strong></td><td>
				 				...
				 				<select name="hours_select" id="hours_select" onchange="updateHours(this)">
				 					<option value="off_hours" <?php if ($season->default_season == 'off_hours') echo "selected='selected'";?> >Fall / Winter (<?=$season->off_hours?>)</option>
				 					...
				 					<option value="peak_hours" <?php if ($season->default_season == 'peak_hours') echo "selected='selected'";?>>Spring / Summer (<?=$season->peak_hours?>)</option>
				 				</select>
				 				<br />
