...
<div id="wrap">
	<div id="container" class="clearfix">
		<div id="header">
			<div id="menu">
			<?php $path="../"; require_once("inc/menu.php"); ?>
			<!--menu--></div>
		<!--header--></div>
		...
		<div id="content" style="width: 880px;  margin: 0 auto;">
			<div id="artist_nav">
						<a style="float: right; margin-left: 35px;" href="<?=$next?>" onclick="return goNext();" title="Click to see next artist<br />or use right keyboard arrow key">Next >></a>
			<a style="float: right;" href="<?=$prev?>"  onclick="return goPrev();" title="Click to see previous artist<br />or use left keyboard arrow key"><< Prev</a>
				...
				<img src="/artists/<?=$artist->grid_thumb?>" style="float: right; margin: 0 0 5px 15px;" alt="<?=stripslashes($artist->name)?>" />			
				 ...
				 <table width="100%" class="contact_info">
				 	...
				 	<tr><td valign="top" ><strong>Hours:</strong></td><td>
				 				...
				 				<select name="hours_select" id="hours_select" onchange="updateHours(this)">
				 					<option value="off_hours" <?php if ($season->default_season == 'off_hours') echo "selected='selected'";?> >Off Season (<?=$season->off_hours?>)</option>
				 					<option value="shoulder_hours" <?php if ($season->default_season == 'shoulder_hours') echo "selected='selected'";?>>Shoulder Season (<?=$season->shoulder_hours?>)</option>
				 					<option value="peak_hours" <?php if ($season->default_season == 'peak_hours') echo "selected='selected'";?>>Peak Season (<?=$season->peak_hours?>)</option>
				 				</select>
				 				<br />
				 				<hr style="margin-top: 4px;" size="1" noshade />
				 	
								<table width="100%" cellpadding="0" cellspacing="0" id="off_hours" class="hours_table">
								<tr <?php if (date('D',time()) == "Mon") echo "class='today'"; ?>><td>Monday:</td><td align="right"> <?=$artist->off_mon?></td></tr>
								<tr <?php if (date('D',time()) == "Tue") echo "class='today'"; ?>><td>Tuesday:</td><td align="right"> <?=$artist->off_tue?></td></tr>
								<tr <?php if (date('D',time()) == "Wed") echo "class='today'"; ?>><td>Wednesday:</td><td align="right"> <?=$artist->off_wed?></td></tr>
								<tr <?php if (date('D',time()) == "Thu") echo "class='today'"; ?>><td>Thursday:</td><td align="right"> <?=$artist->off_thu?></td></tr>
								<tr <?php if (date('D',time()) == "Fri") echo "class='today'"; ?>><td>Friday:</td><td align="right"> <?=$artist->off_fri?></td></tr>
								<tr <?php if (date('D',time()) == "Sat") echo "class='today'"; ?>><td>Saturday:</td><td align="right"> <?=$artist->off_sat?></td></tr>
								<tr <?php if (date('D',time()) == "Sun") echo "class='today'"; ?>><td>Sunday:</td><td align="right"> <?=$artist->off_sun?></td></tr>
								</table>
								
								<table width="100%" cellpadding="0" cellspacing="0" id="shoulder_hours"  class="hours_table">
								<tr <?php if (date('D',time()) == "Mon") echo "class='today'"; ?>><td>Monday:</td><td align="right"> <?=$artist->shoulder_mon?></td></tr>
								<tr <?php if (date('D',time()) == "Tue") echo "class='today'"; ?>><td>Tuesday:</td><td align="right"> <?=$artist->shoulder_tue?></td></tr>
								<tr <?php if (date('D',time()) == "Wed") echo "class='today'"; ?>><td>Wednesday:</td><td align="right"> <?=$artist->shoulder_wed?></td></tr>
								<tr <?php if (date('D',time()) == "Thu") echo "class='today'"; ?>><td>Thursday:</td><td align="right"> <?=$artist->shoulder_thu?></td></tr>
								<tr <?php if (date('D',time()) == "Fri") echo "class='today'"; ?>><td>Friday:</td><td align="right"> <?=$artist->shoulder_fri?></td></tr>
								<tr <?php if (date('D',time()) == "Sat") echo "class='today'"; ?>><td>Saturday:</td><td align="right"> <?=$artist->shoulder_sat?></td></tr>
								<tr <?php if (date('D',time()) == "Sun") echo "class='today'"; ?>><td>Sunday:</td><td align="right"> <?=$artist->shoulder_sun?></td></tr>
								</table>
								
								<table width="100%" cellpadding="0" cellspacing="0" id="peak_hours"  class="hours_table">
								<tr <?php if (date('D',time()) == "Mon") echo "class='today'"; ?>><td>Monday:</td><td align="right"> <?=$artist->peak_mon?></td></tr>
								<tr <?php if (date('D',time()) == "Tue") echo "class='today'"; ?>><td>Tuesday:</td><td align="right"> <?=$artist->peak_tue?></td></tr>
								<tr <?php if (date('D',time()) == "Wed") echo "class='today'"; ?>><td>Wednesday:</td><td align="right"> <?=$artist->peak_wed?></td></tr>
								<tr <?php if (date('D',time()) == "Thu") echo "class='today'"; ?>><td>Thursday:</td><td align="right"> <?=$artist->peak_thu?></td></tr>
								<tr <?php if (date('D',time()) == "Fri") echo "class='today'"; ?>><td>Friday:</td><td align="right"> <?=$artist->peak_fri?></td></tr>
								<tr <?php if (date('D',time()) == "Sat") echo "class='today'"; ?>><td>Saturday:</td><td align="right"> <?=$artist->peak_sat?></td></tr>
								<tr <?php if (date('D',time()) == "Sun") echo "class='today'"; ?>><td>Sunday:</td><td align="right"> <?=$artist->peak_sun?></td></tr>
								</table>
							</td>
				 	</tr>
