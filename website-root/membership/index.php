...
<div id="container">
	...
	<h2 class="mb0">Salt Spring Studio Tour Registration</h2>
			...
			<p> Please log in below to manage your Studio Tour listing.<br />
	If you have lost your login credentials, or your studio is not listed, please contact Dave Davies at davegsc@gmail.com.</p>
			...
			<div class="controls">
				<select name="profile" id="profile" class="w400">
					<?php foreach($profiles as $val) { $val = (object) $val; ?>
						...
						<option value='<?=$val->id?>'>#<?=$val->tour_number?> <?=$val->studio_name?></option>
