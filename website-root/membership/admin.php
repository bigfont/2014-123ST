...
$(function() {
		...
		$('.editable').editable('membership-admin-save.php', {
         cancel    : 'Cancel',
         submit    : 'OK',
         cssclass: 'inplace',
    ...
    <div id="container">
      ...
      <div class="tabbable">
        <ul class="nav nav-tabs">
          <li class="active">
            <a href="#pane1" data-toggle="tab">Members List</a>
          </li>
          <li>
            <a href="#pane2" data-toggle="tab">Add New Member</a>
          </li>
        </ul>
        ...
        <div class="tab-content">
          <div id="pane1" class="tab-pane active">
            <p>
              Click on a studio name or password to edit.  Click on the "Login" button to automatically login to that member's profile for editing.
            </p>
            <table class="tiger" width="100%" cellspacing='2' cellpadding='2'>
              ...
              <tr>
                <td width="30" class="editable" id="tour_number-"
                  <?=$record->id?>"><?=$record->tour_number?>
                </td>
                <td width="400" class="editable" id="studio_name-"
                  <?=$record->id?>"><?=$record->studio_name?>
                </td>
                <td width="300" class="editable" id="password-"
                  <?=$record->id?>"><?=$record->password?>
                </td>
                <td width="150" valign="middle">
                  <form action="index.php" method="post" target="_blank">
                    <input type="hidden" name="profile" value="<?= $record->id ?>" />
                    <input type="hidden" name="password" value="<?= $record->password ?>" />
                    <input type="submit" value="Login" style="position: relative; top: 9px"/>
                  </form>
                </td>
              </tr>
          ...
          <div id="pane2" class="tab-pane">
            ...
            <form action="admin.php" method="post" onsubmit="return checkform()">
              <div class="control-group">
                ...
                <div class="controls">
                  <select name="studio_number" id="studio_number">
                    ...
                    <option
                      <?php if (@$_REQUEST['tour_number'] == $i) { echo "selected='selected'";} ?> value="<?=$i?>"><?=$i?>
                    </option>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="submit" value="Add Member" name="submit" class="btn"/>
                </div>
              </div>
