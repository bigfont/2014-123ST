...
<p>Registration is open until [DATE].  You are free to update your profile until then.  You will be given an opportunity to review your profile before it is printed, but after [DATE] any changes will incur an additional fee.</p>
...
<div class="tabbable">
  <ul class="nav nav-tabs">
    ...
    <li><a href="#pane2" data-toggle="tab">The Book</a></li>
  ...
  <div class="tab-content">
    <div id="pane1" class="tab-pane active">
      <h4>Studio Map</h4>
      <p>These are the details needed for the Studio Map, including both the information and map sides.<br />An example of the map and info sides are shown below: </p><br />
      <img src="images/infosample.jpg" />
...
<div class="control-group">
	<label class="control-label" for="phone">Telephone</label> 
 	...
 	<div class="control-group">
	<label class="control-label" for="info_description">Info Side Description (100 Characters MAX)<small>This is the description that will show up on the information side of the map.</small></label> 
		<div class="controls">
 	...
 	<div class="control-group">
	<label class="control-label" for="map_description">Map Side Description (54 Characters MAX)<small>This is the description that will show up on the map side of the map.</small></label> 
		<div class="controls">
    ...
    <div class="control-group">
	<label class="control-label" for="summer_hours">Spring / Summer Days &amp; Hours<small>May 1st - Sept 30th, Days &amp; Hours</small></label> 
		<div class="controls">
         ...
         <div class="control-group">
	<label class="control-label" for="winter_hours">Fall / Winter Days &amp; Hours<small>Oct 1st - Apr 30th, Days &amp; Hours, or by appointment</small></label> 
			<div class="controls">
...
<hr />
      <div class="control-group"><h4>Options:</h4>
		<div class="controls">
...
<!--pane--></div>
	...
	<h4>The Book</h4>
	<p>Please select the correct template for both left and right pages of your book entry, and provide the copy for each page.  Images can be uploaded in the "Images" tab</p>
	
	<hr />


<div class="control-group"><h4>Book (Left Page)</h4>
	<label class="control-label" for="bookleft_template">Left Page Template Number <small>Please enter which template number you'd like for the left page of your book entry</small></label> 
		<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="bookleft_1">Left Page Copy<small>This is the copy for the left page of your book entry</small></label> 
		<div class="controls">
    ...
    <div class="control-group">
	<label class="control-label" for="bookleft_2">Left Page <strong>Optional</strong> Copy<small>This is optional copy for the left page of your book entry, if your chosen template requires it.</small></label> 
		<div class="controls">
...
<div class="control-group"><h4>Book (Right Page)</h4>
	<label class="control-label" for="bookright_template">Right Page Template Number <small>Please enter which template number you'd like for the right page of your book entry</small></label> 
		<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="bookright_1">Right Page Copy<small>This is the copy for the right page of your book entry</small></label> 
		<div class="controls">
    ...
    <div class="control-group">
	<label class="control-label" for="bookright_2">Right Page <strong>Optional</strong> Copy<small>This is optional copy for the right page of your book entry, if your chosen template requires it.</small></label> 
		<div class="controls">
...
<br />
    ...
    <div id="pane4" class="tab-pane">
      ...
      <p>For more information, click on the Documents tab and review the Book layout sample and the 2014 Book Instructions PDF.</p>
 		...
 		<hr />
      <form action="manage.php?tab=image" method="post" enctype="multipart/form-data" id="imageupload" onsubmit='return checkForm();'>
      	<table cellpadding=5>
      		<tr>
      		...
      		<tr><td>&nbsp;</td><td><input type="submit" name="submit" id="uploadImage" value="Upload Image" />&nbsp;&nbsp;<img src="images/loading.gif" class="loading" /></td></tr>
  		</table>
  		<hr />
...
<hr />
			...
			<div class="control-group">
	<div class="controls"> 
	<button type="button" class="btn">Update My Profile</button> <img src="images/checkmark.gif" id="checkmark" /></div>
	      </div>
<br />
<br />
<br />
