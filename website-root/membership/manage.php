...
<div class="tabbable">
  ...
  <div class="tab-content">
    <div id="pane1" class="tab-pane active">
      ...
      <img src="images/mapsample.jpg" /><br>
      Note that space is extremely limited on the Tour Map. Be concise.
	<hr />
...
<!-- Update My Profile END -->
	...
	<h3><?=$profile->tour_number?> - <?=$profile->studio_name?></h3>
					...
					<!-- input id="last_update" name="last_update" class="css-checkbox" type="timestamp" <?php if ($profile->last_update == 'y') { ?> checked='checked' <?php } ?>/>
					<label for="last_update" name="demo_lbl_1" class="css-label" >Last Update</label -->
...
<!-- New Anniversary Comment field -->
         <div class="control-group">
	<label class="control-label" for="C">I plan to promote the Studio Tour's 25th Anniversary with the following:</em><small><strong>(ie: "Special Edition(s), Anniversary Pricing, etc.) </strong></small></label> 
			<div class="controls">
...
<!-- New BATAH Comment field -->
         <div class="control-group">
	<label class="control-label" for="C">I plan to the following items to the "Be A Tourist At Home" prgram, to entice local residents to visit my studio::</em><small><strong>(ie: "<strong>$25 Gift Certificate</strong>", "<strong>One (1) Table Runner</strong>", "<strong>Five Cedar Cutting Boards</strong>", "<strong>One (1) piece of unique Jewelry</strong>", etc.) </strong></small></label> 
			<div class="controls">
