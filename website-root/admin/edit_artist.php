	...
	<?php require_once('menu.php'); ?>
		...
		<table >
			...
			<tr>
				...
				<tr>
					<td>Blurb:</td><td><input type="text" id="blurb" name="blurb" size="40" value="<?=stripslashes(@$record['blurb'])?>" /></td>
				</tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr> 
